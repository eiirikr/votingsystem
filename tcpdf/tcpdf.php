...
class TCPDF {
	...
	/**
	 * Default destructor.
	 * @publicublic function __destruct() {
	 ...
	 * @publicublic function setLastH($h) {
		$this->lasth = $h;
	}
	 ...
	 * @publicunction setImageScale($scale) {
		$this->imgscale = $scale;
	}
	 ...
	 * @publicMargin(), SetTopMargin(), SetRightMargin(), SetAutoPageBreak()
	 */
	 ...
	 * @publicargin(), SetRightMargin(), SetAutoPageBreak(), SetMargins()
	 */
	 ...
	 * @param $margin (float) The margin.
	 * @publicMargin(), SetRightMargin(), SetAutoPageBreak(), SetMargins()
	 */
	 ...
	 * @param $margin (float) The margin.
	 * @publicMargin(), SetTopMargin(), SetAutoPageBreak(), SetMargins()
	 */
	 ...
	 * @public MultiCell(), AcceptPageBreak()
	 */
	 ...
	 * @publicction SetDisplayMode($zoom, $layout='SinglePage', $mode='UseNone') {
	 ...
	 * @publicction SetCompression($compress=true) {
	 ...
	 * @publicor(), SetCreator(), SetKeywords(), SetSubject()
	 */
	 ...
	 * @publicor(), SetCreator(), SetKeywords(), SetTitle()
	 */
	 ...
	 * @publictor(), SetKeywords(), SetSubject(), SetTitle()
	 */
	 ...
	 * @publicor(), SetCreator(), SetSubject(), SetTitle()
	 */
	 ...
	 * @publicor(), SetKeywords(), SetSubject(), SetTitle()
	 */
	 ...
	 * @publicge(), endPage(), addTOCPage(), endTOCPage(), getPageSizeFromFormat(), setPageFormat()
	 */
	 ...
	 * @param $name (string) spot color name (if any)
	 * @return string the PDF command
	 * @publicColorArray(), SetFillColor(), SetTextColor(), Line(), Rect(), Cell(), MultiCell()
	 */
	 ...
	 * @param $name (string) Spot color name (if any).
	 * @return (string) The PDF command.
	 * @publicColorArray(), SetDrawColor(), SetTextColor(), Rect(), Cell(), MultiCell()
	 */
	 ...
	 * @publicColorArray(), SetDrawColor(), SetFillColor(), Text(), Cell(), MultiCell()
	 */
	 ...
	 * @publicction GetStringWidth($s, $fontname='', $fontstyle='', $fontsize=0, $getarray=false) {
	 ...
	 * @param $size (float) Font size in points. The default value is the current size. If no size has been spec document, the value taken is 12
	 * @param $fontfile (string) The font definition file. By default, the name is built from the family and style, in lower case with no spaces.
	 * @param $subset (mixed) if true embedd only a subset of the font (stores only the information related to the used characters); if false embedd full font; if 'default' uses the default value set using setFontSubsetting(). This option is valid only for TrueTypeUnicode fonts. If you want to enable users to change the document, set this parameter to false. If you subset the font, the person who receives your PDF would need to have your same font in order to make changes to your PDF. The file size of the PDF would also be smaller because you are embedding only part of a font.
	 ...
	 * @public Write(), Image(), Link(), SetLink()
	 */
	 ...
	 * @public(), Annotation(), Cell(), Write(), Image()
	 */
	 ...
	 * @public Write(), MultiCell(), WriteHTML(), WriteHTMLCell()
	 */
	 ...
	 * @param $valign (string) text vertical alignment inside the cell. Possible values are:<ul><li>T : top</li><li>C : center</li><li>B : bottom</li></ul>
	 * @public(), SetDrawColor(), SetFillColor(), SetTextColor(), SetLineWidth(), AddLink(), Ln(), MultiCell(), Write(), SetAutoPageBreak()
	 */
	 ...
	 * @public(), SetDrawColor(), SetFillColor(), SetTextColor(), SetLineWidth(), Cell(), Write(), SetAutoPageBreak()
	 */
	 ...
	 * @param $cellpadding (float) Internal cell padding, if empty uses default cell padding.
	 * @param $border (mixed) Indicates if borders must be drawn around the cell. The value can be a number:<ul><li>0: no border (default)</li><li>1: frame</li></ul> or a string containing some or all of the following characters (in any order):<ul><li>L: left</li><li>T: top</li><li>R: right</li><li>B: bottom</li></ul> or an array of line styles for each border group - for example: array('LTRB' => array('width' => 2, 'cap' => 'butt', 'join' => 'miter', 'dash' => 0, 'color' => array(0, 0, 0)))
	 * @return float Return the minimal height needed for multicell method for printing the $txt param., Alexander Escalona Fern\E1ndez
	 * @public
	 */
	 ...
	 * @publicction Write($h, $txt, $link='', $fill=false, $align='', $ln=false, $stretch=0, $firstline=false, $firstblock=false, $maxh=0, $wadj=0, $margin='') {
		// check page for no-write regions and adapt page margins if necessary
		list($this->x, $this->y) = $this->checkPageRegions($h, $this->x, $this->y);
		if (strlen($txt) == 0) {
			// fix empty text
	 ...
	 * @publicction Image($file, $x='', $y='', $w=0, $h=0, $type='', $link='', $align='', $resize=false, $dpi=300, $palign='', $ismask=false, $imgmask=false, $border=0, $fitbox=false, $hidden=false, $fitonpage=false, $alt=false, $altimgs=array()) {
		if ($this->state != 2) {
			return;
		}
		if (strcmp($x, '') === 0) {
	 ...
	 * @publicction setHeaderFont($font) {
	 ...
	 * Set footer font.
	 * @param $font (array) Array describing the basic font parameters: (family, style, size).
	 * @publicction setFooterFont($font) {
	 ...
	 * @publicction setLanguageArray($language) {
		$this->l = $language;
	 ...
	 * @publicWidth(), SetDrawColor(), SetLineStyle()
	 */
